 ...
 * Author: preilly@php.net, http://www.facebook.com/preilly
...
class GoogleVoice {
    ...
    private $userAgent = 'Mozilla/5.0 (Linux; U; Android 2.2; en-us; Nexus One Build/FRF91) AppleWebKit/533.1 (KHTML, like Gecko) Version/4.0 Mobile Safari/533.1';
    ...
    public function getLoginAuth() {
        $login_param = "accountType=GOOGLE&Email={$this->username}&Passwd={$this->password}&service=grandcentral&source=com.preillyme.GoogleVoiceTool";
    ...
    public function get_rnr_se() {
        ...
        curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, false);
        curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
        $headers = array("Authorization: GoogleLogin auth=".$this->login_auth, "User-Agent: {$this->userAgent}");
